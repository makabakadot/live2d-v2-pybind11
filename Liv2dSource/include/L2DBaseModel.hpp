...
public:
    L2DBaseModel();
    L2DBaseModel(std::shared_ptr<Render>  render);
    ...
    Live2DModelRender* getLive2DModel() const { return mLive2DModel; }
    ...
    Live2DModelRender* mLive2DModel = nullptr;
